...
class TextPreprocessor:
    ...
    def clean_translated(self, text: str) -> str:
        """Nettoyage spécifique pour le texte anglais après traduction"""
        if not text:
            return ""
        # Conversion en minuscule
        text = text.lower()
        # On peut réutiliser la logique de nettoyage existante si disponible
        # Sinon, un nettoyage simple des caractères spéciaux suffit
        import re
